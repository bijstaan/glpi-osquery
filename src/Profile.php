    ...
    private static function rights(): array
    {
        return [
            [
                ...
                'label'    => __('Agents', 'glpiosquery'),
                'field'    => 'plugin_glpiosquery_agent',
            ],
            [
                'itemtype' => SavedQuery::class,
                'label'    => __('Query packs and saved queries', 'glpiosquery'),
                'field'    => 'plugin_glpiosquery_pack',
            ],
            [
                'rights'   => [
                    READ => __('Read'),
                ...
                'label'    => __('Live query', 'glpiosquery'),
                'field'    => 'plugin_glpiosquery_livequery',
            ],
            [
                'rights'   => [
                    UPDATE => __('Run free-form SQL', 'glpiosquery'),
                ],
                'label'    => __('Free-form SQL', 'glpiosquery'),
                'field'    => 'plugin_glpiosquery_rawsql',
            ],
            [
                'rights'   => [
                    UPDATE => __('Publish extensions', 'glpiosquery'),
                ],
                'label'    => __('Extensions', 'glpiosquery'),
                'field'    => 'plugin_glpiosquery_extension',
            ],
        ];
    }
